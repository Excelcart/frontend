...
const UserRoles = () => {
  return (
    <section className='w-full m-auto flex flex-col justify-center items-center px-2 max-w-[95rem] m-auto'>
      <div className='flex flex-col justify-center items-center py-16 lg:pt-24'>
      ...
      <div className='px-6 lg:px-0'>
        <div className='flex items-center md:gap-10 gap-3'>
          ...
          <p className='font-normal md:text-xl text-xs sm:text-sm mt-2 w-[95%]'>
